...
App: **tt-blog-92mj5** at https://tt-blog-92mj5.vibekit.bot
Repo: template/blog | Port: 4044 | Container: vk-tt-blog-92mj5
...
- Never mention localhost. App URL: **https://tt-blog-92mj5.vibekit.bot**.
- Verify before claiming success: `curl -s -o /dev/null -w "%{http_code}" https://tt-blog-92mj5.vibekit.bot/`.
...
- Must listen on **0.0.0.0:4044**, never localhost.
